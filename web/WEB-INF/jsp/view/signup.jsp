            ...
            <div class="contact">
                <div class="container">
                    ...
                    <form action="signup" method="POST">
                        <input type="text" name="userID" placeholder="USERNAME" value="${param["userID"]}" required=""  maxlength="10">
                        <input type="password" name="password" placeholder="PASSWORD" required=""  maxlength="30">			 
                        <input type="text" name="fullName" placeholder="FULL NAME" value="${param["fullName"]}" required=""  maxlength="100">			 
                        <input type="submit" value="SIGN UP">
                    </form>
                    <c:forEach var="error" items="${errorList}">
                        <p style="color: orangered">${error.message}</p>
                    </c:forEach>
